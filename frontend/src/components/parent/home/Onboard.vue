    ...
    >
      ...
      <v-stepper-content step="1">
        <v-card>
          <v-card-subtitle
            class="black--text"
          >단추로 용돈을 받고, 투자도 한다고? <br> 단추가 뭐길래?</v-card-subtitle>
          <v-card-actions>
            <v-btn
              block
              color="parent01"
      ...
      <v-stepper-content step="2">
        <v-card>
          <v-card-subtitle
            class="black--text"
          >단추를 얻는 첫 번째 방법! <br> 아이의 직업을 정해볼까요?</v-card-subtitle>
          <v-card-actions>
            <v-btn
              block
              color="parent01"
      ...
      <v-stepper-content step="3">
        <v-card>
          <v-card-subtitle
            class="black--text"
          >부모님 몸무게에 투자해볼까? <br> 투자도 쉽고 재미있게!</v-card-subtitle>
          <v-card-actions>
            <v-btn
              block
              color="parent01"

            ...
            <template v-slot:body>
              ...
              >
                ...
                <div class="mx-4">
                  ...
                  <div class="text-body-2 my-4">아이가 모아둔 단추로 <br> {{ buyRequest.productName }}를 사고 싶어합니다.</div>
                  <v-row dense>
          ...
          >
            <template v-slot:body>
              ...
              >
                ...
                <div class="mx-4">
                  <div class="text-h4 font-weight-bold">{{ exchangeRequest.amount }}원</div>
                  <div class="text-subtitle-1 my-2">{{ exchangeRequest.status === 'approved' ? '환전 완료' : '환전 요청 거절' }}</div>
                </div>
              </v-card>
            </template>
          </bottom-sheet>
          ...
          >
            <template v-slot:body>
              ...
              >
                ...
                <div class="mx-4">
                  <div class="text-h5 font-weight-bold">{{ buyRequest.productName }}</div>
                  <div class="text-subtitle-1 my-2">{{ buyRequest.status === 'approved' ? '구매 완료' : '구매 요청 거절' }}</div>
                </div>
              </v-card>
            </template>
          </bottom-sheet>

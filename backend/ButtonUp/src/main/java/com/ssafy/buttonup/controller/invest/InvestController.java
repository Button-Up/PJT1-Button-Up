...
public class InvestController {
    ...
    public void addStock(@ApiParam(value = "새로운 주식 정보", required = true) @RequestBody StockRequest request) throws ExistStockException {
    ...
    public ResponseEntity<List<RoughStockResponse>> viewInvestList(@ApiParam(value = "부모 키", required = true) @PathVariable("parent_seq") long parentSeq) {
